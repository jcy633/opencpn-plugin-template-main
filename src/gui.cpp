...
ncdfDialog::ncdfDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, wxSize(420, 650), style )
{
	...
	sizerCurr->AddSpacer(0);
	m_checkBoxAnisoDiffCurr = new wxCheckBox( m_panelCurrSettings, wxID_ANY, _("Anisotropic diffusion") );
	sizerCurr->Add( m_checkBoxAnisoDiffCurr, 0, wxALL, 3 );
	sizerCurr->AddSpacer(0);
	m_checkBoxSCurveCurr = new wxCheckBox( m_panelCurrSettings, wxID_ANY, _("S-curve color mapping") );
	sizerCurr->Add( m_checkBoxSCurveCurr, 0, wxALL, 3 );
	sizerCurr->AddSpacer(0);
	m_checkBoxSlopeCurr = new wxCheckBox( m_panelCurrSettings, wxID_ANY, _("Slope shading overlay") );
	sizerCurr->Add( m_checkBoxSlopeCurr, 0, wxALL, 3 );
	sizerCurr->AddSpacer(0);
	...
	sizerSST->AddSpacer(0);
	m_checkBoxAnisoDiffSST = new wxCheckBox( m_panelSSTSettings, wxID_ANY, _("Anisotropic diffusion") );
	sizerSST->Add( m_checkBoxAnisoDiffSST, 0, wxALL, 3 );
	sizerSST->AddSpacer(0);
	m_checkBoxSCurveSST = new wxCheckBox( m_panelSSTSettings, wxID_ANY, _("S-curve color mapping") );
	sizerSST->Add( m_checkBoxSCurveSST, 0, wxALL, 3 );
	sizerSST->AddSpacer(0);
	...
	sizerSal->AddSpacer(0);
	m_checkBoxAnisoDiffSal = new wxCheckBox( m_panelSalSettings, wxID_ANY, _("Anisotropic diffusion") );
	sizerSal->Add( m_checkBoxAnisoDiffSal, 0, wxALL, 3 );
	sizerSal->AddSpacer(0);
	m_checkBoxSCurveSal = new wxCheckBox( m_panelSalSettings, wxID_ANY, _("S-curve color mapping") );
	sizerSal->Add( m_checkBoxSCurveSal, 0, wxALL, 3 );
	sizerSal->AddSpacer(0);
	...
	m_checkBoxAnisoDiffCurr->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ncdfDialog::onAnisoDiffCurrClick ), NULL, this );
	...
	m_checkBoxAnisoDiffSST->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ncdfDialog::onAnisoDiffSSTClick ), NULL, this );
	m_checkBoxSCurveSST->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ncdfDialog::onSCurveSSTClick ), NULL, this );
	m_checkBoxSlopeSST->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ncdfDialog::onSlopeSSTClick ), NULL, this );
	...
	m_checkBoxAnisoDiffSal->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ncdfDialog::onAnisoDiffSalClick ), NULL, this );
	m_checkBoxSCurveSal->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ncdfDialog::onSCurveSalClick ), NULL, this );
	m_checkBoxSlopeSal->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ncdfDialog::onSlopeSalClick ), NULL, this );
...
ncdfDialog::~ncdfDialog()
{
	...
	m_checkBoxAnisoDiffCurr->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ncdfDialog::onAnisoDiffCurrClick ), NULL, this );
	...
	m_checkBoxAnisoDiffSST->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ncdfDialog::onAnisoDiffSSTClick ), NULL, this );
	m_checkBoxSCurveSST->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ncdfDialog::onSCurveSSTClick ), NULL, this );
	m_checkBoxSlopeSST->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ncdfDialog::onSlopeSSTClick ), NULL, this );
	...
	m_checkBoxAnisoDiffSal->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ncdfDialog::onAnisoDiffSalClick ), NULL, this );
	m_checkBoxSCurveSal->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ncdfDialog::onSCurveSalClick ), NULL, this );
	m_checkBoxSlopeSal->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( ncdfDialog::onSlopeSalClick ), NULL, this );

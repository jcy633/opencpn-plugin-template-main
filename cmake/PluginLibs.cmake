...
if (WIN32 AND DEFINED ENV{WXWIN})
  set(wxWidgets_ROOT_DIR $ENV{WXWIN})
  set(wxWidgets_INCLUDE_DIRS "$ENV{WXWIN}/include")
  set(wxWidgets_LIBRARY_DIR "$ENV{WXWIN}/lib/vc145_dll")
elseif (WIN32)
  set(wxWidgets_ROOT_DIR "${PROJECT_SOURCE_DIR}/cache/wxWidgets")
  set(wxWidgets_INCLUDE_DIRS "${PROJECT_SOURCE_DIR}/cache/wxWidgets/include")
  set(wxWidgets_LIBRARY_DIR "${PROJECT_SOURCE_DIR}/cache/wxWidgets/lib/vc_dll")
endif ()

...
// MSVC C++17 compatibility: Force cmath to use legacy behavior
#if defined(_MSC_VER) && _MSC_VER >= 1910
#define _ALLOW_CXX17_DEPRECATED_C_HEADERS
#endif
...
// MSVC C++17 compatibility: Use std:: namespace for float math functions
#if defined(_MSC_VER) && _MSC_VER >= 1910
namespace texfont_msvc_compat {
// These inline functions call the std:: versions which are always available
// in MSVC's C++17 mode
inline float msvc_sinf(float x) { return sinf(x); }
inline float msvc_cosf(float x) { return cosf(x); }
inline float msvc_sqrtf(float x) { return sqrtf(x); }
inline float msvc_powf(float x, float y) { return powf(x, y); }
inline float msvc_expf(float x) { return expf(x); }
inline float msvc_logf(float x) { return logf(x); }
inline float msvc_log10f(float x) { return log10f(x); }
inline float msvc_floorf(float x) { return floorf(x); }
inline float msvc_ceilf(float x) { return ceilf(x); }
inline float msvc_fabsf(float x) { return fabsf(x); }
inline float msvc_fmodf(float x, float y) { return fmodf(x, y); }
inline float msvc_atan2f(float y, float x) { return atan2f(y, x); }
inline float msvc_asinf(float x) { return asinf(x); }
inline float msvc_acosf(float x) { return acosf(x); }
inline float msvc_tanf(float x) { return tanf(x); }
inline float msvc_sinhf(float x) { return sinhf(x); }
inline float msvc_coshf(float x) { return coshf(x); }
inline float msvc_tanhf(float x) { return tanhf(x); }
inline float msvc_ldexpf(float x, int y) { return ldexpf(x, y); }
inline float msvc_frexpf(float x, int* y) { return frexpf(x, y); }
}
// Note: The functions are already in global namespace via math.h
